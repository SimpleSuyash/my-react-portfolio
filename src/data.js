...
export const projectsData = [
  ...
  },
  {
    ...
    description:'A simple workday scheduler built using HTML, CSS, and JavaScript',
  },
  {
    id:4,
  ...
  },
  {
    ...
    description:'A logo generator built using Node.js and Inquirer, and tested using Jest',
  },
  {
    id: 9,
    name: 'Note Taker',
  ...
  },
  {
    ...
    description: 'An e-commerce ORM built using Node.js, Express.js, MySQL, and Sequelize',
  },
  {
    id: 12,
    name: 'The Tech Blog',
    ...
    description: 'A tech blog built using Node.js, Express.js, MySQL, and Handlebars',
  },
  {
    id: 13,
    name: 'Lets Brag',
    ...
    description: 'A social media app built using Node.js, Express.js, MySQL, and Handlebars',
  },
  {
    id: 14,
    ...
    description: 'A social network API built using Node.js, Express.js, MongoDB and Mongoose',
  },
  {
    id: 15,
    ...
    description: 'A PWA text editor built using Node.js, Express.js, IndexedDB, and Service Worker',
  }
];